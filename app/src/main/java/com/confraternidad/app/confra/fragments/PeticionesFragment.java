...
public class PeticionesFragment extends Fragment {
    ...
    private EditText txt_titulo_peticion, txt_peticion;
        ...
        if(mFirebaseAuth.getCurrentUser() == null){
            ...
            btn_peticion.setOnClickListener(v -> {
                AlertDialog alertDialog = new AlertDialog.Builder(getActivity())
                        ...
                        .setPositiveButton("Si", (dialog, which) -> enviarPeticion())
...
//                                Collections.reverse(peticionesList);
    ...
    private void enviarPeticion(){
        ...
        if (txt_titulo_peticion.getText().toString().length() == 0){
            ...
            mDatabase.child("peticiones").child(uid).setValue(mapPeticiones).addOnCompleteListener(task -> {
    ...
    public static void showPopupContacto(final Context context, final String liderName, final String liderPhone, final String liderAvatar, final String uidContainer){
        ...
        //Botones de Accion
        ImageButton btn_contactar_phone, btn_contactar_msg, btn_contactar_wapp;
        ...
        btn_contactar_msg = popupContacto.findViewById(R.id.btn_contactar_msg);
        btn_contactar_msg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                phoneAction(context, liderPhone, "msg");
            }
        });
        Glide.with(context).load(R.drawable.contact_msg)
                .centerInside()
                .into(btn_contactar_msg);
